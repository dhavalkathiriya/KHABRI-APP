...
// 4903bb7d663044079d805e378d3b0c36
...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4903bb7d663044079d805e378d3b0c36&page=1&pageSize=${this.props.pageSize}`;
    ...
    HandlePrevClick = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4903bb7d663044079d805e378d3b0c36&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        let data = await fetch(url);
        let finalData = await data.json();
